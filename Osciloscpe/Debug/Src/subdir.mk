...
Src/%.o Src/%.su Src/%.cyclo: ../Src/%.c Src/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m3 -std=gnu11 -g3 -DDEBUG -DSTM32F103RBTx -DSTM32 -DSTM32F1 -c -I../Inc -I"C:/Users/vthat/STM32CubeIDE/BareMetalUdemy/chip_headers/CMSIS/Device/ST/STM32F1xx/Include" -I"C:/Users/vthat/STM32CubeIDE/BareMetalUdemy/chip_headers/CMSIS/Include" -O0 -ffunction-sections -fdata-sections -Wall -u _printf_float -fstack-usage -fcyclomatic-complexity -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@"
